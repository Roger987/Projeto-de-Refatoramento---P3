...
import modelo.Iterator;
import modelo.IteratorUsuario;
    ...
    public static void mostrarUsuarios(){
        ...
        if (usuarios.size() == 0){
            ...
            System.out.print("              (\\-.\n" +
                            ...
                            "      `-.__(___)_   | o O . o |\n" +
                            "                    `---------'\n");
            Iterator IteratorUsuario = new IteratorUsuario((ArrayList<Usuario>) usuarios);
            while(IteratorUsuario.hasNext()){
            	Usuario user = (Usuario)IteratorUsuario.next();
